;(function() {
    ...
    describe("formLabel directive - check ng-show='true'", function() {
        ...
        beforeEach(inject(function($compile, $rootScope) {
            $scope = $rootScope;
            elem = angular.element('<form name="form"><input form-label="test" ng-show="model.test" id="test" name="test" /></form>');
    ...
    describe("formLabel directive - check ng-show='false'", function() {
        ...
        it('DONT renders the html element as required.',
            function() {
                inject(function ($compile) {
                    ...
                    expect($scope.model.test).toBe('false');
                    expect(elem.find('.form-group')).toBeTruthy();
                    expect(elem.find('label')).toBeTruthy();
                    expect(elem.find('input')).toBeTruthy();
                    expect(elem.find('.form-group').hasClass('ng-hide')).toBeTruthy();
    ...
    describe("formLabel directive - check form-append'", function() {
        ...
        beforeEach(inject(function($compile, $rootScope) {
            $scope = $rootScope;
            elem = angular.element('<form name="form"><input form-append="test" form-label="test" ng-show="model.test" id="test" name="test" /></form>');
